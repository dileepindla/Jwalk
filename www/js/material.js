...
! function () {
    ...
    window.componentHandler = function () {
        function e(e, s) {
            for (var t = 0; t < c.length; t++)
                if (c[t].className === e) return void 0 !== s && (c[t] = s), c[t];
            return !1
        }
    ...
    window.MaterialIconToggle = r, r.prototype.Constant_ = {
        TINY_TIMEOUT: .001
    ...
    window.MaterialMenu = _, _.prototype.Constant_ = {
        ...
        if (this.element_ && this.container_) {
            ...
            if (s && s.length > 0 && this.container_.classList.contains(this.CssClasses_.IS_VISIBLE)) {
                ...
                if (e.keyCode === this.Keycodes_.UP_ARROW) e.preventDefault(), t > 0 ? s[t - 1].focus() : s[s.length - 1].focus();
                else if (e.keyCode === this.Keycodes_.DOWN_ARROW) e.preventDefault(), s.length > t + 1 ? s[t + 1].focus() : s[0].focus();
    ...
    window.MaterialSwitch = u, u.prototype.Constant_ = {
        TINY_TIMEOUT: .001
    ...
    window.MaterialDataTable = I, I.prototype.Constant_ = {}, I.prototype.CssClasses_ = {
        ...
        return s ? function () {
            ...
            var s, i;
            if (e.checked)
                for (s = 0; s < t.length; s++) i = t[s].querySelector("td").querySelector(".mdl-checkbox"), i.MaterialCheckbox.check(), t[s].classList.add(this.CssClasses_.IS_SELECTED);
            else
                for (s = 0; s < t.length; s++) i = t[s].querySelector("td").querySelector(".mdl-checkbox"), i.MaterialCheckbox.uncheck(), t[s].classList.remove(this.CssClasses_.IS_SELECTED)
        }.bind(this) : void 0
